...
class TravelTasks():
    ...
    def __tip_section(self):
        return "If you do your BEST WORK, I'll tip you $10000 and grant you any wish you want!"
    # Task: Location
    ...
    def planner_task(self, context, agent, destination_city, interests, date_from, date_to):
        return Task(
            ...
            {self.__tip_section()}
            Follow this rules : 
            2. Give the schedule for each day
            3. There should be a time based plan for each day
            """,
