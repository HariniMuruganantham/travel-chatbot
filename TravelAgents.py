...
class TravelAgents():
    ...
    def __init__(self) -> None:
        # Use CrewAI's LLM wrapper with Groq model
        # Using llama-3.1-8b-instant for better rate limits on free tier
        # Alternative: llama-3.3-70b-versatile (better quality but lower rate limits)
        self.llm = LLM(
    ...
    def location_expert(self):
        return Agent(
            ...
            goal="Adapt to the user destination city. Gather helpful information about to the city and city during travel.",
